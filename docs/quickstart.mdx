...
<Note>
This table shows key failure handling defaults. See [Configuration](configuration) for the complete list of 54 configuration options (29 in `RateLimiterConfig` + 25 in `StateConfig`).
</Note>
